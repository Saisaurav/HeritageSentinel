...
const TTS_MODELS = {
  ...
  'fr': process.env.PIPER_MODEL_FR || 'C:\\piper\\models\\fr_FR-upmc-medium.onnx',
  'es': process.env.PIPER_MODEL_ES || 'C:\\piper\\models\\es_ES-sharvard-medium.onnx',
  'de': process.env.PIPER_MODEL_DE || 'C:\\piper\\models\\de_DE-thorsten-medium.onnx',
  'it': process.env.PIPER_MODEL_IT || 'C:\\piper\\models\\it_IT-riccardo-x_low.onnx',
  'ru': process.env.PIPER_MODEL_RU || 'C:\\piper\\models\\ru_RU-ruslan-medium.onnx',
  'zh': process.env.PIPER_MODEL_ZH || 'C:\\piper\\models\\zh_CN-huayan-medium.onnx',
};
